...
import br.com.startscode.ReadPath;
...
public class Request {
	...
	public JSONObject send(JSONObject requestOptions) throws AuthorizationException, GerencianetException, IOException, JSONException {
		byte[] postDataBytes;
		...
		if (responseCode == HttpURLConnection.HTTP_OK || responseCode == HttpURLConnection.HTTP_CREATED) {
			...
			JSONTokener responseTokener = new JSONTokener(new ReadPath().InputStreamToStringPath(responseStream));
