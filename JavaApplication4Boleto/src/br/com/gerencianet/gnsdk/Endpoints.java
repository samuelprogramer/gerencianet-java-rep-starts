...
public class Endpoints {
	...
	public Endpoints(JSONObject options) throws Exception 
	{
		...
		JSONTokener tokener = new JSONTokener(new ReadPath().InputStreamToStringPath("config.json"));
	...
	private String getRoute(JSONObject endpoint, Map<String, String> params) throws JSONException 
	{
